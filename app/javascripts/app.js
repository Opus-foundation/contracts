...
const tokenAddress = "0xb112d409e8B9cd4b3ab81c41851615Eb2c8e3616";
const songListAddress = "0x18Cebb2A1c58d492269BdBF675B3EB73dA0c4bbE";
  ...
  displayFromWorkList: ()=>{
    ...
    _.forIn(workList, function(value, key) {
      ...
      if (_work.owned){
        ...
        //html += `</span>
        html +=   `<img src="img/cover.png" alt="cover" class="cover">
